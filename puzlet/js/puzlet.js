  ...
  Gist = (function() {
    ...
    Gist.prototype.getAuth = function() {
      ...
      if (!this.username) {
        ...
        document.cookie = "gh_user=" + this.username;
      }
      this.key = $.cookie("gh_key");
      if (!this.key) {
        this.key = window.prompt("GitHub personal access token");
        if (!this.key) {
          return null;
        }
        document.cookie = "gh_key=" + this.key;
      }
