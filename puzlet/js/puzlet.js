...
(function() {
  var ArrayMath, AxesLabels, BlabCoffee, BlabPlotter, BlabPrinter, CoffeeResource, ComplexMath, CssResourceInline, CssResourceLinked, EvalBoxPlotter, FavIcon, Figure, GithubRibbon, HtmlResource, JsResourceInline, JsResourceLinked, JsonResource, Loader, MathJaxProcessor, NumericFunctions, OLDLoader, OLDPage, OLDResources, Page, Resource, Resources, ScalarMath, TypeMath, getBlabFromQuery, getFileDivs, init,
  ...
  */
  ...
  Resource = (function() {
    ...
    Resource.prototype.load = function(callback, type) {
      ...
      return $.get(this.url, success, type);
    };
  ...
  CssResourceInline = (function(_super) {
    ...
    CssResourceInline.prototype.load = function(callback) {
      var _this = this;
      return CssResourceInline.__super__.load.call(this, function() {
        _this.style = $("<style>", {
          type: "text/css",
          "data-url": _this.url
        });
        _this.style.append(_this.content);
        return typeof callback === "function" ? callback() : void 0;
      });
    };

    CssResourceInline.prototype.inDom = function() {
      return $("style[data-url='" + this.url + "']").length;
    };

    CssResourceInline.prototype.appendToHead = function() {
      if (!this.inDom()) {
        return this.head.appendChild(this.style[0]);
      }
    };
  ...
  JsResourceInline = (function(_super) {
    ...
    JsResourceInline.prototype.load = function(callback) {
      var _this = this;
      return JsResourceInline.__super__.load.call(this, function() {
        _this.script = $("<script>", {
          type: "text/javascript",
          "data-url": _this.url
        });
        _this.script.append(_this.content);
        return typeof callback === "function" ? callback() : void 0;
      });
    };

    JsResourceInline.prototype.inDom = function() {
      return $("script[data-url='" + this.url + "']").length;
    };

    JsResourceInline.prototype.appendToHead = function() {
      if (!this.inDom()) {
        return this.head.appendChild(this.script[0]);
      }
    };
