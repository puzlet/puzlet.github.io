...
(function() {
  ...
  */
  ...
  Gist = (function() {
    ...
    Gist.prototype.saveAfterAuth = function() {
    ...
    Gist.prototype.getAuth = function(callback) {
      var make_base_auth, _ref,
        _this = this;
      ...
      if ((_ref = this.credentialsForm) == null) {
        this.credentialsForm = new CredentialsForm(this.username, this.key);
      }
      return this.credentialsForm.open(function() {
        ...
        if (_this.username && _this.key) {
          ...
          _this.authBeforeSend = function(xhr) {
  ...
  CredentialsForm = (function() {
    ...
    function CredentialsForm(username, key, callback) {
      var _this = this;
    ...
    CredentialsForm.prototype.open = function(callback) {
      this.callback = callback;
  ...
  Ace.EditorNode = (function(_super) {
    ...
    EditorNode.prototype.create = function() {
      ...
      return this.editor = new Editor(this.spec);
    };
  ...
  Loader = (function() {
    ...
    */
    ...
    Loader.prototype.loadGist = function(callback) {
      this.gist = new Gist(this.resources);
      return this.gist.load(callback);
    };
  ...
  init = function() {
    ...
    ready = function() {
      return page.ready(loader.resources, loader.gist.id);
    };
