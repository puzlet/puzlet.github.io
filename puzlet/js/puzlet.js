...
(function() {
  ...
  */
  ...
  CoffeeResource = (function(_super) {
    ...
    CoffeeResource.prototype.createElement = function() {
      return this.element = $("<script>", {
  ...
  Ace.Editors = (function() {
    ...
    function Editors(findResource) {
      ...
      this.editors = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          container = _ref[_i];
          _results.push(this.createEditor($(container)));
        }
        return _results;
      }).call(this);
      $pz.codeNode = {};
    ...
    Editors.prototype.createEditor = function(container) {
      var Editor, filename, lang, resource, spec, _ref;
      filename = container.attr(Ace.Editor.fileAttr);
      resource = this.findResource(filename);
      if (!resource) {
        return null;
      }
      ...
      spec = {
        ...
        update: function(code) {
          return typeof resource.update === "function" ? resource.update(code) : void 0;
        }
      };
  ...
  Ace.Editor = (function() {
    ...
    function Editor(spec) {
      ...
      this.session().setValue(this.spec.code);
      this.initRenderer();
      this.initFont();
      this.setHeight();
    ...
    Editor.prototype.changeAction = function() {
