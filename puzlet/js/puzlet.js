...
(function() {
  ...
  */
  ...
  CoffeeResource = (function(_super) {
    ...
    CoffeeResource.prototype.load = function(callback) {
      ...
      return CoffeeResource.__super__.load.call(this, function() {
        _this.hasEval = Ace.EvalNode.find(_this.url).length;
  ...
  Ace.Node = (function() {
    ...
    Node.find = function(url) {
      return $("div[" + this.fileAttr + "='" + url + "']");
    };

    function Node(container, findResource) {
      this.container = container;
    ...
    Node.prototype.getSpec = function() {
      var fileAttr;
      fileAttr = this.constructor.fileAttr;
      this.filename = this.container.attr(fileAttr);
      this.resource = this.findResource(this.filename);
      if (!this.resource) {
        return;
      }
  ...
  Ace.Nodes = (function() {
    ...
    Nodes.prototype.Node = Ace.Node;

    function Nodes(findResource) {
      var container;
      this.findResource = findResource;
      this.fileAttr = this.Node.fileAttr;
      this.containers = $("div[" + this.fileAttr + "]");
      this.nodes = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          container = _ref[_i];
          _results.push(this.createNode($(container)));
        }
        return _results;
      }).call(this);
    }

    Nodes.prototype.createNode = function(container) {
      return new this.Node(container, this.findResource);
    };
  ...
  Ace.Editors = (function(_super) {

    __extends(Editors, _super);

    Editors.prototype.Node = Ace.EditorNode;

    function Editors(findResource) {
      var editor, _i, _len, _ref;
      this.findResource = findResource;
      $pz.AceIdentifiers = Ace.Identifiers;
      Editors.__super__.constructor.call(this, this.findResource);
      $pz.codeNode = {};
      _ref = this.nodes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        editor = _ref[_i];
  ...
  Ace.Evals = (function(_super) {

    __extends(Evals, _super);

    function Evals() {
      return Evals.__super__.constructor.apply(this, arguments);
    }

    Evals.prototype.Node = Ace.EvalNode;
