...
(function() {
  var ArrayMath, AxesLabels, BlabCoffee, BlabPlotter, BlabPrinter, ComplexMath, EvalBoxPlotter, Figure, Loader, MathJaxProcessor, NumericFunctions, Page, Resources, ScalarMath, TypeMath, getBlabFromQuery, getFileDivs, init,
  ...
  */
  ...
  Page = (function() {
    ...
    function Page(blab, loader, callback) {
      var _this = this;
      this.blab = blab;
      this.loader = loader;
    ...
    Page.prototype.render = function(wiky) {
      var container,
        _this = this;
    ...
    Page.prototype.htmlNode = function(container) {
      var html;
  ...
  init = function() {
    ...
    return loader.loadCoreResources(function() {
      return new Page(blab, loader, function() {
