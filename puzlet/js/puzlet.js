...
(function() {
  var ArrayMath, AxesLabels, BlabCoffee, BlabPlotter, BlabPrinter, CoffeeEvaluator, ComplexMath, EvalBoxPlotter, Figure, MathJaxProcessor, NumericFunctions, Resources, ScalarMath, TypeMath, getBlab, getBlabId, getFileDivs, githubForkRibbon, htmlNode, init, init0, loadExtrasJs, loadMainCss, loadMainHtml, loadMainJs,
  ...
  */
  ...
  Resources = (function() {
    ...
    Resources.prototype.resourcesClass = "lab_resources";

    function Resources(spec, callback) {
      this.spec = spec;
    ...
    Resources.prototype.process = function() {
      var l, moduleIdRegEx, postfix, prefix, r, resourceHtml, resources, t, _i, _len;
      ...
      for (_i = 0, _len = resources.length; _i < _len; _i++) {
        ...
        if (!r || typeof r !== "string") {
          ...
          prefix = "/" + r + "/";
          postfix = "&t=" + t;
          this.addCoffee(prefix + "main.coffee" + postfix);
          this.addCss(prefix + "main.css" + postfix);
          l = "/m/" + r;
        } else if (r.indexOf(".js") !== -1) {
          this.addScript(r);
        } else if (r.indexOf(".css") !== -1) {
          this.addCss(r);
        } else {
    ...
    Resources.prototype.removeResources = function() {
      var resources;
      resources = $("." + this.resourcesClass);
      if (resources.length) {
        return resources.remove();
      }
    };

    Resources.prototype.addCoffee = function(url) {
      var _this = this;
      ...
      return $.ajax({
        ...
        return _this.resourceLoaded();
      });
    };

    Resources.prototype.addScript = function(url) {
      var $js, js,
        _this = this;
      this.wait = true;
      this.resourcesToLoad++;
      $js = $("<script>", {
        "class": this.resourcesClass,
        type: "text/javascript",
        src: url
      });
      js = $js[0];
      ...
      return this.head.appendChild(js);
    };

    Resources.prototype.addCss = function(url) {
      var $css, css,
        _this = this;
      this.wait = true;
      this.resourcesToLoad++;
      ...
      return this.head.appendChild(css);
    };

    Resources.prototype.resourceLoaded = function() {
      this.resourcesToLoad--;
    ...
    Resources.prototype["eval"] = function() {
      var recompile, result, stringify, _ref;
      if (!(((_ref = this.code()) != null ? _ref.trim().length : void 0) > 0)) {
        return null;
      }
      recompile = true;
      stringify = false;
      return result = this.evaluator.process(this.code(), recompile, stringify);
    };
