...
(function() {
  var ArrayMath, AxesLabels, BlabCoffee, BlabPlotter, BlabPrinter, ComplexMath, EvalBoxPlotter, Figure, MathJaxProcessor, NumericFunctions, ScalarMath, TypeMath, getBlab, gistTest, htmlNode, ribbon,
  ...
  */
  ...
  gistTest = function() {
    ...
    $.get(url2, function(data) {
      return console.log("gist data", data);
    });
    d = {
    ...
    return $.ajax({
      ...
      success: function(data) {
        return console.log("create gist", data);
      },
      dataType: "json"
    });
  };
